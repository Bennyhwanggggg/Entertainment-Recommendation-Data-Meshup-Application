...
$(".animes").click(function(){/* table1_Animes*/
    ...
    const url = 'http://127.0.0.1:5000/show/animes?count='+numtoshow+'&genre='+genretoshow+'&title='+typetoshow+'&rate_start='+start_rate + '&rate_end='+end_rate+'&order='+up_down;
    fetch(url, {
        method: 'get'
